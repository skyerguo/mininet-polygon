# sudo timeout 430 sudo LD_LIBRARY_PATH=${root} ${root}/client ${target_anycast} $port -i -p $data_type -o $opt -w $website --client_ip ${client_ip} --client_process ${port} --time_stamp ${time_stamp} -q 1>> /home/mininet/client_tmp_${port}.log 2>> /home/mininet/experiment_results/anycast_${unique_identifier}.log
