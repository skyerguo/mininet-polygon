...
do
    ...
    rm /home/mininet/speed_router_$server_num.txt
    ...
    sudo LD_LIBRARY_PATH=/home/mininet/data /home/mininet/data/client ${server_ip} 4433 -i -p video -o 1 -w $website --client_ip 123.123.123.123 --client_process 4433 --time_stamp $time_stamp -q 1>> /dev/null 2>> /home/mininet/speed_router_$server_num.txt
    # sudo 
    PLT_num=`sudo tac /home/mininet/speed_router_$server_num.txt | grep -c "PLT"`
    time_spend=`sudo tac /home/mininet/speed_router_$server_num.txt | grep -a "PLT" |head -n 1| awk '{print $2}'`
    while [[ $time_spend == 0 || $PLT_num -ne 2 ]] 
    do
        sleep 10
        rm /home/mininet/speed_router_$server_num.txt
        sudo LD_LIBRARY_PATH=/home/mininet/data /home/mininet/data/client ${server_ip} 4443 -i -p video -o 1 -w $website --client_ip 123.123.123.123 --client_process 4433 --time_stamp $time_stamp -q 1>> /dev/null 2>> /home/mininet/speed_router_$server_num.txt
    done
    ...
    # echo rate > /home/mininet/initial_${router_num}_${server_num}.txt

    ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null gtc@${server_ip} "echo $rate > /home/mininet/initial_${router_num}.txt"
    # sleep
done
